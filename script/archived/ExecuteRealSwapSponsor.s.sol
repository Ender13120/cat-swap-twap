...
contract ExecuteRealSwapSponsor is Script {
    ...
    function run() external {
        ...
        console.log("\nUser signature created (signed by USER)");

        // Resume broadcast with sponsor key
        vm.startBroadcast(sponsorPrivateKey);
        ...
        console.log("\nExecuting real swap with sponsor paying gas...");
        ...
        try WALLET.executeSwap(swapOrder, swapCall, userSig) returns (
            ...
            console.log("Gas paid by sponsor:", sponsor);
